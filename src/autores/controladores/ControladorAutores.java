...
//    private int bandera=1;
    ...
    public ControladorAutores() {
        ...
        this.ventana = new VentanaAMAutores(this,null,true);
        ...
        ventana.ModificarBorrarAlumno();
        ventana.ModificarBorrarProfesor();
        ventana.setVisible(true);//se hace visible la ventana
    }


    public void setVentana(VentanaAMAutores ventana) {
...
//    }
    ...
    public void btnNuevoProfesorClic(ActionEvent evt) { 
      ...
      IControladorAMProfesor cp =(IControladorAMProfesor) new ControladorAMProfesor();
    ...
    public void btnNuevoAlumnoClic(ActionEvent evt) {
       IControladorAMAlumno ca=(IControladorAMAlumno) new ControladorAMAlumno();
    ...
    Profesor p= mtp.verProfesor(this.ventana.getTablaProfesores().getSelectedRow());
     IControladorAMProfesor controlador = (IControladorAMProfesor) new ControladorAMProfesor("Modificar Profesor", false, false, p);
    ...
    IControladorAMAlumno caa=(IControladorAMAlumno) new ControladorAMAlumno("Modificar Alumno",false,false,a);
    mtp.actualizar();
    }
